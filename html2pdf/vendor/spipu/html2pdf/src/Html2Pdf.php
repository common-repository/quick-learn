...
<html>
    ...
    protected function _tag_open_DIV($param, $other = 'div')
    {
        ...
        $marge = array();
        $marge['l'] = $this->parsingCss->value['border']['l']['width'] + $this->parsingCss->value['padding']['l'];
        $marge['r'] = $this->parsingCss->value['border']['r']['width'] + $this->parsingCss->value['padding']['r'];
        $marge['t'] = $this->parsingCss->value['border']['t']['width'] + $this->parsingCss->value['padding']['t'];
        $marge['b'] = $this->parsingCss->value['border']['b']['width'] + $this->parsingCss->value['padding']['b'];
    ...
    protected function _tag_open_HR($param)
    {
        ...
        $this->parsingCss->value['text-align'] = 'center';
